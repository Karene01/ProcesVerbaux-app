 ...
 */
final class Version20250608075850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE ASSEMBLEE_GENERALE (id_assemblee_generale INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, id_copropriete INTEGER DEFAULT NULL, assemblee_generale_id INTEGER NOT NULL, date_assemblee_generale DATETIME DEFAULT NULL, heure_assemblee_generale TIME DEFAULT NULL, ouverte BOOLEAN NOT NULL, terminee BOOLEAN DEFAULT 0 NOT NULL, date_commencement DATETIME DEFAULT NULL, CONSTRAINT FK_853401B3FEE9CE2 FOREIGN KEY (id_copropriete) REFERENCES COPROPRIETE (id_copropriete) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_853401B3BBE76FA9 FOREIGN KEY (assemblee_generale_id) REFERENCES ASSEMBLEE_GENERALE (id) NOT DEFERRABLE INITIALLY IMMEDIATE)
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE INDEX IDX_853401B3BBE76FA9 ON ASSEMBLEE_GENERALE (assemblee_generale_id)
        SQL);
    }
